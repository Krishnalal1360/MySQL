...
select orderid, customerid, employeeid, orderdate, freight, shippeddate, shipname, shipcity, shipcountry from orders;
...
(36, 'Inlagd Sill', 17, 8, '24 - 250 gjars', '19.0000', 112, 0, 20, b'0'),
...
select productid, productname, supplierid, categoryid, quantityperunit, unitprice from products where categoryid!=1;

select productid, productname, supplierid, categoryid, quantityperunit, unitprice from products where supplierid!=1;

select productid, productname, quantityperunit, unitprice from products where unitprice>100.00;

select productid, productname, quantityperunit, unitprice, unitsinstock from products where unitsinstock<10;

select productid, productname, quantityperunit, unitprice from products where unitprice<=20.00;
...
select employeeid, firstname, lastname, title, hiredate, city, country, salary from employees;

select employeeid, firstname, lastname, title, hiredate, city, country, salary from employees
where hiredate>="1994-01-01 00:00:00";

select * from products;

select productid, productname, quantityperunit, unitprice, unitsinstock from products
where unitprice>20.00 and unitsinstock>50.00;
...
select orderid, customerid, employeeid, orderdate, shippeddate, freight, shipname, shipcity, shipcountry from orders
where (shipcountry="Germany" or shipcountry="Switzerland") and freight>=100.00;

select * from products;

select productid, productname, supplierid, categoryid, quantityperunit, unitprice from products
where (categoryid=1 or categoryid=8) and unitprice>=50.00;
...
select orderid, customerid, employeeid, orderdate, shippeddate, freight, shipname, shipcity, shipcountry from orders
where shipcountry in ("Brazil","USA","France");

select * from employees;

select employeeid, firstname, lastname, title, hiredate, address, city, country, salary from employees
where title not in ("Sales Representative","Sales Manager");

select * from customers;

select customerid, companyname, contactname, address, city, country, phone, fax from customers
where fax is null;

select customerid, companyname, contactname, address, city, country, phone, fax from customers
where fax is null and phone is null;
...
select orderid, customerid, employeeid, orderdate, shippeddate, freight, shipname, shipcity, shipcountry from orders
where freight<any (select freight from orders where orderid=10249);

select orderid, customerid, employeeid, orderdate, shippeddate, freight, shipname, shipcity, shipcountry from orders
where freight>any (select freight from orders where orderid=10249);

select freight from orders where orderid=10249;

select * from products;

select productid, productname, supplierid, categoryid, quantityperunit, unitprice from products
where unitprice>all (select unitprice from products where categoryid=8);

select productid, productname, supplierid, categoryid, quantityperunit, unitprice from products
where unitprice<all (select unitprice from products where categoryid=8);

select unitprice from products where categoryid=8;
...
select supplierid, companyname, contactname, contacttitle, address, city, country from suppliers;

select supplierid, companyname, contactname, contacttitle, address, city, country from suppliers
where country in ("Australia","Japan","Singapore");
